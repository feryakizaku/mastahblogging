...
Lalu silahkan kalian copy code javascript dibawah ini, taruh di notepad dan ganti link panduanblog.online/p/go-to-url.html dengan link laman yang kalian buat tadi. Simpan dengan format .js misalnya safelink.js. Upload ke Github atau hostingan kalian dan simpan link safelink.js yang sudah kalian upload tadi.
...
function auto_safeconvert() {
    ...
    for (var i = 0; i < a_to_va; i++) {
        ...
        if (a_to_vh == false) {
            ...
            a_to_ve[i].href = "https://www.mastahblogging.com/p/blog-page.html?url=" + encryptedUrl;
